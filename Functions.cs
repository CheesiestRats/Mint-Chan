...
namespace Mint_Chan
{
    class Functions
    {
        ...
        {
            var Context = new SocketCommandContext(GlobalConfig.Client, Msg);
            ...
            string imgPrompt = $"1girl, solo, looking at viewer, short hair, green hair, green eyes, medium breasts{timeOfDayStr}{imgFormatString}"; // POSITIVE PROMPT - put what you want the image to look like generally. The AI will put its own prompt after this.
            string imgNegPrompt = $"easynegative, badhandv4"; // NEGATIVE PROMPT HERE - put what you don't want to see
